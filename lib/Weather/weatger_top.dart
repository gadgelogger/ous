//todo:再利用可能なコンポーネントを分ける
//))などの間にカンマを入れるように警告を出すLintをつける
//通信処理と画面のUIを分ける
//Freezedを使ってみる
                      ...
                      Text(
                        DateFormat('M/d(E)HH:mm').format(
                            DateTime.fromMillisecondsSinceEpoch(
                                weatherData['dt'] * 1000)),
                        style: TextStyle(
                          fontSize: 20.sp, //themedataを調べてみる
                        ),
                      ),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          ...
                          Text(
                            (weatherData['main']['temp'] - 273.15)
                                ...
                                "°",
                            style: TextStyle(
                                fontSize: 80.sp, //themedataを調べてみる
...
class _ImabariState extends State<Imabari> {
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        body: weatherData != null
            ? NewWidget(weatherData: weatherData, forecast: forecast)
            : const Center(
                child: CircularProgressIndicator(),
              ),
      );
