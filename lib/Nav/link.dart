        ...
        body: ListView(
          children: <Widget>[
            ...
            ListTile(
                ...
                trailing: const Icon(Icons.link),
                onTap: () =>
                    launch('https://www.ous.ac.jp/campuslife/services/')),
            ListTile(
                title: const Text(
                  '各種相談窓口',
                ),
                ...
                trailing: const Icon(Icons.link),
                onTap: () =>
                    launch('http://www.ous.ac.jp/students/counseling/')),
            ListTile(
                title: const Text(
                  '各種証明書・申請書の発行',
                ),
            ...
            ListTile(
                ...
                trailing: const Icon(Icons.link),
                onTap: () =>
                    launch('https://www.ous.ac.jp/students/insurance/')),
            ListTile(
                title: const Text(
                  'キャリア支援センター',
                ),
            ...
            ListTile(
                ...
                trailing: const Icon(Icons.link),
                onTap: () =>
                    launch('http://career.office.ous.ac.jp/kyousyoku/')),
            ListTile(
                title: const Text(
                  '情報基盤センター',
                ),
            ...
            ListTile(
                ...
                trailing: const Icon(Icons.link),
                onTap: () =>
                    launch('http://www.ous.ac.jp/students/kyousyoku/')),
            ListTile(
                title: const Text(
                  '寄付金について',
                ),
            ...
            ListTile(
                ...
                trailing: const Icon(Icons.link),
                onTap: () =>
                    launch('http://renkei.office.ous.ac.jp/ousresnavi/')),
            const Divider(
              height: 1.0,
              indent: 1.0,
            ),
