...
class kyousyoku extends StatefulWidget {
  @override
  _kyousyokuState createState() => _kyousyokuState();
}
...
class _kyousyokuState extends State<kyousyoku> {
  ...
  Future<List<AlgoliaObjectSnapshot>> _search(String query) async {
    final result =
    await _algolia.instance.index('kyousyoku').search(query).getObjects();
...
//algolia
            ...
            : StreamBuilder(
          stream:
          FirebaseFirestore.instance.collection('kyousyoku').snapshots(),
...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  Future<void> addToFavorites(String documentId, String userId) async {
    ...
    final originalDocRef = FirebaseFirestore.instance.collection('kyousyoku').doc(documentId);
