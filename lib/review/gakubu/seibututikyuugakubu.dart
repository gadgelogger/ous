...
class seibutu extends StatefulWidget {
  const seibutu({Key? key}) : super(key: key);

  @override
  _seibutuState createState() => _seibutuState();
}

class _seibutuState extends State<seibutu> {
  ...
  Future<List<AlgoliaObjectSnapshot>> _search(String query) async {
    final result =
    await _algolia.instance.index('seibutu').search(query).getObjects();
...
//algolia
            ...
            : StreamBuilder(
          stream:
          FirebaseFirestore.instance.collection('seibutu').snapshots(),
...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  Future<void> addToFavorites(String documentId, String userId) async {
    ...
    final originalDocRef = FirebaseFirestore.instance.collection('seibutu').doc(documentId);
