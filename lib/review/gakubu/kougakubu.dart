...
//大学のアカウント以外は非表示にする
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          elevation: 0,
          title: !_searchBoolean ? Text('工学部') : _searchTextField(),
