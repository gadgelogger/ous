...
class keieigakubu extends StatefulWidget {
  const keieigakubu({Key? key}) : super(key: key);

  @override
  State<keieigakubu> createState() => _keieigakubuState();
}
...
class _keieigakubuState extends State<keieigakubu> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
          child: StreamBuilder(
            stream: _firestore.collection('keiei').snapshots(),
            builder:
