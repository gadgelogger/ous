...
final index = algolia.instance.index('zyouhou');

class zyouhourikougakubu extends StatefulWidget {
  const zyouhourikougakubu({Key? key}) : super(key: key);

  @override
  State<zyouhourikougakubu> createState() => _zyouhourikougakubuState();
}
...
class _zyouhourikougakubuState extends State<zyouhourikougakubu> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          elevation: 0,
          title: !_searchBoolean ? Text('情報理工学部') : _searchTextField(),
