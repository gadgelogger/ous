...
class _zyouhouState extends State<zyouhou> {
  ...
  Future<List<AlgoliaObjectSnapshot>> _search(String query) async {
    final result =
    await _algolia.instance.index('zyouhou').search(query).getObjects();
...
//algolia
            ...
            : StreamBuilder(
          stream:
          FirebaseFirestore.instance.collection('zyouhou').snapshots(),
...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  Future<void> addToFavorites(String documentId, String userId) async {
    ...
    final originalDocRef = FirebaseFirestore.instance.collection('zyouhou').doc(documentId);
