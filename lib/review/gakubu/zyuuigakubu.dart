...
class zyuui extends StatefulWidget {
  const zyuui({Key? key}) : super(key: key);

  @override
  _zyuuiState createState() => _zyuuiState();
}

class _zyuuiState extends State<zyuui> {
  ...
  Future<List<AlgoliaObjectSnapshot>> _search(String query) async {
    final result =
    await _algolia.instance.index('zyuui').search(query).getObjects();
...
//algolia
            ...
            : StreamBuilder(
          stream:
          FirebaseFirestore.instance.collection('zyuui').snapshots(),
...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  Future<void> addToFavorites(String documentId, String userId) async {
    ...
    final originalDocRef = FirebaseFirestore.instance.collection('zyuui').doc(documentId);
