...
class kiban extends StatefulWidget {
  ...
  @override
  _kibanState createState() => _kibanState();
}
...
class _kibanState extends State<kiban> {
  ...
  Future<List<AlgoliaObjectSnapshot>> _search(String query) async {
    final result =
    await _algolia.instance.index('kiban').search(query).getObjects();
...
//algolia
            ...
            : StreamBuilder(
          stream:
          FirebaseFirestore.instance.collection('kiban').snapshots(),
...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  Future<void> addToFavorites(String documentId, String userId) async {
    ...
    final originalDocRef = FirebaseFirestore.instance.collection('kiban').doc(documentId);
