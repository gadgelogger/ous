...
class kougaku extends StatefulWidget {
  const kougaku({Key? key}) : super(key: key);

  @override
  State<kougaku> createState() => _kougakuState();
}

class _kougakuState extends State<kougaku> {
